...
var c=require('@stdlib/complex-float64-base-mul/dist');function j(a,i,e,t){var u,r;if(a<=0||t<=0)return e;if(t===1){for(r=0;r<a;r++)e.set(c(i,e.get(r)),r);return e}for(u=0,r=0;r<a;r++)e.set(c(i,e.get(u)),u),u+=t;return e}o.exports=j
});var l=n(function(B,f){
var R=require('@stdlib/complex-float64-base-mul/dist');function _(a,i,e,t,u){var r,s;if(a<=0||t<=0)return e;for(r=u,s=0;s<a;s++)e.set(R(i,e.get(r)),r),r+=t;return e}f.exports=_
